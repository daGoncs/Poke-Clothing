package github.dagoncs.pokeclothing.provider;

import github.dagoncs.pokeclothing.provider.builder.TailoringRecipeBuilder;
...
public class PokeClothingRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        // PROFESSOR OAK SET
        TailoringRecipeBuilder.create(ItemInit.PROFESSOR_OAK.chestplate())
                .input(whiteCloth, 6).input(redCloth, 2)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.PROFESSOR_OAK.leggings())
                .input(brownCloth, 7)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.PROFESSOR_OAK.boots())
                .input(blackCloth, 4)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);
        ...
        TailoringRecipeBuilder.create(ItemInit.HOENN_ASH.chestplate())
                .input(blueCloth, 4).input(blackCloth, 2).input(whiteCloth, 1).input(yellowCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.HOENN_ASH.leggings())
                .input(lightBlueCloth, 7)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.HOENN_ASH.boots())
                .input(blueCloth, 2)
                .input(whiteCloth, 1)
                .input(grayCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
        ...
        TailoringRecipeBuilder.create(ItemInit.SINNOH_ASH.leggings())
                .input(lightBlueCloth, 7)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.SINNOH_ASH.boots())
                .input(redCloth, 2)
                .input(whiteCloth, 1)
                .input(grayCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
        ...
        // CYRUS SET
        TailoringRecipeBuilder.create(ItemInit.CYRUS.chestplate())
                .input(grayCloth, 3).input(lightGrayCloth, 2).input(whiteCloth, 2).input(yellowCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.CYRUS.leggings())
                .input(grayCloth, 5).input(lightGrayCloth, 2)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.CYRUS.boots())
                .input(lightBlueCloth, 4)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        // TEAM GALACTIC GRUNT SET
        TailoringRecipeBuilder.create(ItemInit.TEAM_GALACTIC_GRUNT.chestplate())
                .input(grayCloth, 3).input(lightGrayCloth, 2).input(whiteCloth, 2).input(yellowCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.TEAM_GALACTIC_GRUNT.leggings())
                .input(grayCloth, 5).input(lightGrayCloth, 2)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.TEAM_GALACTIC_GRUNT.boots())
                .input(lightGrayCloth, 4)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        // UNOVA ASH SET
        TailoringRecipeBuilder.create(ItemInit.UNOVA_ASH.helmet())
                .input(redCloth, 2).input(whiteCloth, 2).input(blueCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.UNOVA_ASH.chestplate())
                .input(whiteCloth, 2).input(blueCloth, 2).input(blackCloth, 2).input(yellowCloth, 1).input(redCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.UNOVA_ASH.leggings())
                .input(lightGrayCloth, 7)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.UNOVA_ASH.boots())
                .input(redCloth, 2)
                .input(whiteCloth, 1)
                .input(blackCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
        ...
        // KALOS ASH SET
        TailoringRecipeBuilder.create(ItemInit.KALOS_ASH.helmet())
                .input(redCloth, 3).input(whiteCloth, 2)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.KALOS_ASH.chestplate())
                .input(blueCloth, 3).input(whiteCloth, 2).input(blackCloth, 2).input(redCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.KALOS_ASH.leggings())
                .input(cyanCloth, 7)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.KALOS_ASH.boots())
                .input(redCloth, 1)
                .input(whiteCloth, 1)
                .input(blackCloth, 1)
                .input(blueCloth, 1)
        ...
        // SERENA SET
        TailoringRecipeBuilder.create(ItemInit.SERENA.helmet())
                .input(pinkCloth, 4).input(blackCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.SERENA.chestplate())
                .input(redCloth, 4).input(grayCloth, 4)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.SERENA.leggings())
                .input(grayCloth, 4)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.SERENA.boots())
                .input(blackCloth, 4)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        // ALOLA ASH SET
        TailoringRecipeBuilder.create(ItemInit.ALOLA_ASH.helmet())
                .input(redCloth, 3).input(whiteCloth, 1).input(blueCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.ALOLA_ASH.chestplate())
                .input(blueCloth, 4).input(whiteCloth, 4)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.ALOLA_ASH.leggings())
                .input(grayCloth, 2)
                .input(redCloth, 2)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.ALOLA_ASH.boots())
                .input(blueCloth, 2)
                .input(lightBlueCloth, 1)
                .input(whiteCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        // GALAR ASH SET
        TailoringRecipeBuilder.create(ItemInit.GALAR_ASH.helmet())
                .input(redCloth, 3).input(whiteCloth, 1).input(limeCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.GALAR_ASH.chestplate())
                .input(blueCloth, 3).input(whiteCloth, 3).input(yellowCloth, 1).input(redCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.GALAR_ASH.leggings())
                .input(cyanCloth, 4)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
                .offerTo(exporter);

        TailoringRecipeBuilder.create(ItemInit.GALAR_ASH.boots())
                .input(blueCloth, 2)
                .input(grayCloth, 1)
                .input(whiteCloth, 1)
                .criterion("has_cloth", conditionsFromTag(PokeClothingTagProvider.CLOTH))
