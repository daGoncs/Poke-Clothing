...
public class ArmorMaterialInit {
    ...
    public static final RegistryEntry<ArmorMaterial> PROFESSOR_OAK = register("professor_oak");
    ...
    public static final RegistryEntry<ArmorMaterial> CYRUS = register("cyrus");
    public static final RegistryEntry<ArmorMaterial> TEAM_GALACTIC_GRUNT = register("team_galactic_grunt");
    ...
    public static final RegistryEntry<ArmorMaterial> SERENA = register("serena");
