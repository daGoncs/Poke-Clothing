package github.dagoncs.block.entity.custom;

import github.dagoncs.block.entity.ImplementedInventory;
import github.dagoncs.block.entity.ModBlockEntities;
import github.dagoncs.data.provider.PokeClothingTagProvider; // <--- ADD IMPORT
